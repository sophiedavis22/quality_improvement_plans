...
expected_output_list <- list(A_division=expected_output_list_a,
                             B_division=expected_output_list_b)

test_division_names <- c("A_division", "B_division")
dummy_output <- get_risk_dimension_table(dummy_list, test_division_names)
