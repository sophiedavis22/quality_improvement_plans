...
dummy_output_all <- extract_all_metrics_unnamed(test_file_paths, test_config_file)
dummy_output_error <- extract_all_metrics_unnamed(test_file_paths_error, test_config_file)
...
expected_output_all <- list(list(expected_output_1m,
                        expected_output_2m,
                        expected_output_3m,
                        expected_output_4m),
                        list(expected_output_1a,
                        expected_output_2a,
                        expected_output_3a,
                        expected_output_4a))
