...
dummy_output_error <- merge_metric_table(dummy_data_error, test_config_file)

dummy_output_all <- merge_metric_table(dummy_data_all, test_config_file)
dummy_output_all
...
expected_output_all <- data.frame(month=factor(expected_months, levels=expected_months),
