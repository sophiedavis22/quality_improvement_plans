...
dummy_output <- get_final_risk_dimension_table(dummy_data)

expected_output <- data.frame(dimension=c("Money", "People", "Time", "Tech", "Speed", "No. quality risks"),
                              A_division=c(2,2,1,0,2,2),
                              B_division=c(2,3,2,0,2,3),
                              total=c(4,5,3,0,4,5),
                              pct=c("80%", "100%", "60%", "0%", "80%", "100%"))
